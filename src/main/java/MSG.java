...
public abstract class MSG {
    ...
    public static final int GET_MESSAGES_FO_DATE = 28;
    public static final int XML_GET_MESSAGES_FO_DATE = 29;//id actions

    public static final int ADD_MESSAGES = 30;
    public static final int XML_ADD_MESSAGES = 31;//id actions

    public static final int UPDATE_RECYCLER_VIEV_ADD_MESSAGES = 32;

    // public static final int UPDATE_RECYCLER_VIEV_LOAD_RUN = 33;

    public static final int UPDATE_RECYCLER_VIEV_ADD_MESSAGES_DATE = 34;


    public static final int UPDATE_RECYCLER_VIEV_ADD_CONVERSATION_ALL = 35;

    public static final int UPDATE_RECYCLER_VIEV_ADD_CONVERSATION = 36;
    ...
    public static final int XML_RESULT_VALUES_INSUFFICIENT_ACCESS_RIGHTS = 105;
    ...
    public static final String XML_ELEMENT_COUNT = "count";
